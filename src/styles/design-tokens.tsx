export const typography = {
  menuLink: `group flex items-center gap-4 text-blue-500 leading-tight text-5xl md:text-9xl hover:underline md:gap-10`,
  inlineLink: `font-medium hover:underline`,
  headerLink: `font-medium`
};
